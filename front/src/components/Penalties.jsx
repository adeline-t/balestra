...
export default function Penalties({ penaltyCounts, setPenaltyCounts, autoCombatPenalty }) {
        ...
        {PENALTY_PRESETS.map((p) => {
            ...
            return (
              <div key={p.id} className="penalty-row">
                <div>
                  ...
                  <span className="muted penalty-meta">{p.group} - disqualificatif</span>
                </div>
          ...
          return (
            <div key={p.id} className="penalty-row">
              <div>
                <strong>{p.label}</strong>
                <span className="muted penalty-meta">{p.group} - -{p.value} / occurrence</span>
              </div>
              <div className="penalty-controls">
